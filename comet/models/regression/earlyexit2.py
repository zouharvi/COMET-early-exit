...
========================
    Early exit 2 referenceless regression Metric that learns to predict a quality assessment by
...
class EarlyExit2Regression(RegressionMetric):
    ...
    def __init__(
        ...
        super(RegressionMetric, self).__init__(
            ...
            class_identifier="earlyexit2_metric",
        ...
        assert confidence_target is not None, "Confidence target must be set for EarlyExit2Regression"
