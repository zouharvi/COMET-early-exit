...
for lang in set(x["langs"] for x in data_test):
    # 2k from each language
    for _ in range(2000):
        data_test_sample.append(data_test_by_langs[lang].pop(RANDOM_TEST.randint(0, len(data_test_by_langs[lang])-1)))
...
print("TEST SAMPLE: ", len(data_test_sample))
