from transformers import (FSMTForConditionalGeneration, FSMTTokenizer,
                          M2M100ForConditionalGeneration, M2M100Tokenizer, M2M100Model)

from efficient_reranking.lib import datasets

DEEN_MODEL_NAME = "facebook/wmt19-de-en"
ENDE_MODEL_NAME = "facebook/wmt19-en-de"
...
def load_model_and_tokenizer(src_lang, tgt_lang):
    if src_lang == "de" and tgt_lang == "en":
        ...
        model = FSMTForConditionalGeneration.from_pretrained(ENDE_MODEL_NAME)
        tokenizer = FSMTTokenizer.from_pretrained(ENDE_MODEL_NAME)
    else:
