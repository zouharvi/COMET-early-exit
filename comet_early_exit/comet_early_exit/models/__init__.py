...
from .regression.earlyexitmulti import EarlyExitMultiRegression
from .regression.earlyexitconf import EarlyExitConfRegression
from .regression.earlyexitconfmulti_extra import EarlyExitConfMultiRegressionExtra
from .regression.earlyexitconfmulti import EarlyExitConfMultiRegression
from .regression.earlyexit_conversion import EarlyExitRegressionConversion
from .regression.regression_metric import RegressionMetric
from .regression.instantconf import InstantConfRegression
from .regression.direct_uncertainty_prediction import DirectUncertaintyPrediction
from .download_utils import download_model_legacy


str2model = {
    "earlyexit_metric": EarlyExitRegression,
    "earlyexitmulti": EarlyExitMultiRegression,
    "earlyexit_metric_conversion": EarlyExitRegressionConversion,
    "earlyexitconf_metric": EarlyExitConfRegression,
    "earlyexitconfmulti_extra": EarlyExitConfMultiRegressionExtra,
    "earlyexitconfmulti": EarlyExitConfMultiRegression,
    "instantconf_metric": InstantConfRegression,
    "direct_uncertainty_prediction": DirectUncertaintyPrediction,
