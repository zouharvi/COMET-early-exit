...
class EarlyExitMultiRegression(RegressionMetric):
    ...
    def __init__(
        ...
        super(RegressionMetric, self).__init__(
            ...
            class_identifier="earlyexitmulti",
    ...
    def predict_step(
        ...
        output = self(**batch)
        return Prediction(scores=output.score)
    ...
    def predict(
        ...
        also returns for each segment score
        ...
        Return:
            Prediction object with `scores`, `system_score` and any metadata returned
                by the model.
        """
        # NOTE: this function was copied from base.py 
